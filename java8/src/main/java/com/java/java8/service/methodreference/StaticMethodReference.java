...
public class StaticMethodReference {
    ...
    public static Employee empWithParams(Employee emp){
        return emp;
    }

    public Employee instanceTestWithParams() {
        EmpWithParam empWithParams = StaticMethodReference::empWithParams;
        return empWithParams.getEmployee(Java8Application.employees.get(0));
    }

    //predefined FI
    public static void empWithPredefinedFI(){
        log.info("Thread Runnnin static.....");
    }

    public void instanceTestWithPredefinedFI() {
        Runnable thread = StaticMethodReference::empWithPredefinedFI;
    ...
    public Integer instanceTestWithPredefinedFIBinaryOperator() {
    ...
    public void instanceTestWithOverloading() {
        IntBinaryOperator add = StaticMethodReference::sum;
